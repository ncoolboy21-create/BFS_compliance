...
def main() -> None:
    docs = [
        ...
        build_doc("POL-009", "policy", "Synthetic Compliance Policy", "global", "Synthetic compliance policy defines synthetic test-control records used for validation and benchmarking of compliance retrieval and citation behavior.", "Synthetic policy records must be labeled, non-production, and reviewed for factual alignment before inclusion in evaluation datasets."),
